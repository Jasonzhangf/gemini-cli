...
// Mock @fanzhang/gemini-cli-core-hijack and its Config class
vi.mock('@fanzhang/gemini-cli-core-hijack', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('@fanzhang/gemini-cli-core-hijack')>();
